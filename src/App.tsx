...
const App = () => {
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-[#a3e635] selection:text-black">
      ...
      <section id="about" className="h-screen flex items-center justify-center bg-zinc-900 border-t border-white/5">
        <h2 className="text-4xl font-bold text-gray-500">About Section</h2>
      </section>

      <section id="projects" className="h-screen flex items-center justify-center bg-black border-t border-white/5">
        <h2 className="text-4xl font-bold text-gray-500">Projects Section</h2>
      </section>

      <section id="contact" className="h-screen flex items-center justify-center bg-zinc-900 border-t border-white/5">
        <h2 className="text-4xl font-bold text-gray-500">Contact Section</h2>
      </section>
