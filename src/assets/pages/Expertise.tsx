...
const expertiseDomains: DomainItem[] = [
    ...
    },
    {
        ...
        subtitle: "Deploying and managing automated server environments, containerized apps, and CI/CD pipelines.",
        highlights: ["Docker Containerization", "Server Hosting & DNS", "CI/CD Deployment", "Version Control Systems"],
        skills: [
            { name: "Docker", icon: "🐳" },
            { name: "Git & GitHub", icon: "⌥" },
            { name: "DNS & Networking", icon: "🌐" },
            { name: "CI/CD & Hosting", icon: "☁️" },
        ],
    },
];
