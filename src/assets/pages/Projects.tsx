            ...
            <div className="">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-[#fdfba4] rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden group min-h-[600px] flex flex-col justify-end">
                        ...
                        {/* Project Info (Overlay/Bottom) if needed, currently leaving clean as per screenshot or adding a subtle title */}
                        <div className="relative z-10 pt-[400px] pointer-events-none">
                            {/* Can add titles here if desired, but screenshot shows clean mockups. 
                                I'll leave it clean but prepared for content. */}
                        </div>
                    </div>

                    {/* Project 2 - Pink Card (Code/Desktop) */}
                    <div className="bg-[#ffcddf] rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden group min-h-[600px] flex flex-col justify-center items-center">
                        ...
                        <div className="w-full max-w-lg transition-transform duration-500 group-hover:scale-105">
                            ...
                            {/* Floating Toolbar Mockup (Bottom) */}
