        ...
        >
            ...
            <div className="flex items-center gap-6 md:gap-10">
                {navLinks.map((link) => (
                    ...
                    >
                        {link.name}
                        <span className={`absolute -bottom-1 left-0 h-[1px] bg-[var(--primary)] transition-all duration-300 
            ...
            <div className={`hidden md:flex items-center ml-12 ${isScrolled ? '' : ''}`}>
                <button className="text-white hover:text-[var(--primary)] transition-colors p-2 glass rounded-full">
